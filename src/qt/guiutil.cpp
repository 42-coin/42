...
void SetBlackThemeQSS(QApplication& app)
{
    app.setStyleSheet("QWidget        { background: rgb(41,44,48); }"
					  ...
					  "QMenu::item:selected { background-color: rgb(68,81,98); }"
                      ...
                      "QToolButton:checked { color: rgb(255,255,255); border: none; border-left-color: rgb(68,81,98); border-left-style: solid; border-left-width: 6px; }"
